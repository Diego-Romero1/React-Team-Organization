...
const Formulario = (props) => {
   ...
   return <section className="formulario">
        <form onSubmit={manejarEnvio}>
            ...
            <Campo titulo="Puesto" placeholder="Ingrese el pueste" required valor={puesto} actualizarValor={actualizarPuesto} />
            <Campo titulo="Foto" placeholder="Ingrese enlace de la foto" required valor={foto} actualizarValor={actualizarFoto} />
            <ListaOpciones valor={equipo} actualizarEquipo={actualizarEquipo} equipos={props.equipos} />
            <Boton texto="Crear" />
        </form>
        <form onSubmit={manejarNuevoEquipo}>
            <h2>Rellena el formulario para crear el equipo.</h2>
            <Campo titulo="Equipo" placeholder="Ingrese el nombre del equipo" required valor={titulo} actualizarValor={actualizarTitulo} />
